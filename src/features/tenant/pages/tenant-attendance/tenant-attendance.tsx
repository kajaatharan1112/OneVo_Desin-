...
export const TenantAttendance: React.FC = () => {
  return (
    <div className="content-card">
      ...
      <h3 style={{ fontSize: '1.1rem', fontWeight: 600, color: 'var(--text-h)', marginBottom: '8px' }}>
        Tenant Attendance Portal
      </h3>
      <p style={{ fontSize: '0.85rem', color: '#6b7280', maxWidth: '400px', margin: '0 auto' }}>
        This is a dedicated workspace panel for the tenant's custom attendance monitoring interface.
      </p>
    </div>
  );
};
