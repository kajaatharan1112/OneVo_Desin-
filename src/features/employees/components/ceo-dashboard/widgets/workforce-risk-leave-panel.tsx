...
export const WorkforceRiskLeavePanel: React.FC = () => {
  const { departmentRisk, keyLeaveCases } = ceoDashboardData.workforce;
  const cases = keyLeaveCases;
  ...
  return (
    <article className="eto-widget cwo-cell--riskLeave cwf-panel cwf-panel--riskleave cwf-riskleave">
      <header className="cwf-riskleave__head">
        <div className="cwf-riskleave__title-block">
          ...
          <div className="cwf-riskleave__titles">
            ...
            <p className="cwf-riskleave__subtitle">Department risk and key leave cases</p>
          </div>
        </div>
        {criticalCount > 0 ? (
      ...
      <div className="cwf-riskleave__grid">
        <section className="cwf-riskleave__col" aria-label="Department attendance risk">
          ...
          <div className="cwf-riskleave__dept-cards nexus-scroll-y">
        ...
        <section className="cwf-riskleave__col cwf-riskleave__col--leave" aria-label="Key leave cases">
          <span className="cwf-riskleave__section-label">Key leave cases</span>
          <ul className="cwf-riskleave__case-list nexus-scroll-y" aria-label="Key leave cases">
            {cases.map((item) => (
